    ...
    with app.app_context():
        try:
            ...
            for student in students:
                ...
                body = f"Hi {student.name},\n\nHere are your tasks for this week...{week[student.internship_week]}"
                send_email(student.email, subject, body)
                student.internship_week = student.internship_week+1  # new_week_value is an integer
                db.session.commit()
